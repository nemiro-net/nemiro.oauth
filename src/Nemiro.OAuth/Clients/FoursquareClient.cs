...
namespace Nemiro.OAuth.Clients
{
  ...
  public class FoursquareClient : OAuth2Client
  {
    ...
    /// </summary>
    /// <param name="clientId">The <b>App key</b> obtained from the <see href="https://foursquare.com/oauth">Foursquare Apps</see>.</param>
    /// <param name="clientSecret">The <b>App secret</b> obtained from the <see href="https://foursquare.com/oauth">Foursquare Apps</see>.</param>
